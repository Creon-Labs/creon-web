...
const proposalStatusBadgeVariants = cva(
...
export interface ProposalStatusBadgeProps extends VariantProps<
  typeof proposalStatusBadgeVariants
> {
...
export function ProposalStatusBadge({
  ...
  return (
    <Badge
      ...
      variant="outline"
      className={cn(proposalStatusBadgeVariants({ status, size }), className)}
    >
