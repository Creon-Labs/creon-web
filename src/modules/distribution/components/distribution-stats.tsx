    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            $
            {totalAmountDistributed.toLocaleString("en-US", {
      ...
      <Card>
        ...
        <CardContent>
          ...
          <CardDescription>Total amount claimed by investors</CardDescription>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <CardDescription>Distributions ready to be claimed</CardDescription>
        </CardContent>
      </Card>
    </div>
  )
