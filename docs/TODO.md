...
- [ ] **Jadikan total milestone sebagai validasi form, bukan hanya informasi.**
...
- [ ] **Validasi ukuran dan MIME file di schema frontend.**
...
- [ ] **Perhitungkan media yang sudah tersimpan ketika menambah file.**
...
- [ ] **Tampilkan statistik aktual proposal.**
...
- [ ] **Polling status proposal setelah `SUBMITTED`.**
...
- [ ] **Tampilkan hasil rejection dengan alasan yang dapat ditindaklanjuti.**
